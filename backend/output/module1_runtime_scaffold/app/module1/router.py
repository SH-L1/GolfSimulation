...
from app.module1.schemas import AnalyzeResponse, AnalysisResultResponse, AnalysisStatusResponse, SessionListResponse
...
async def analyze(
    ...
    return await service.enqueue_analysis(video, viewtype, clubtype, trimstart, trimend)
